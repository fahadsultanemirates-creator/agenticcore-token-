// AgenticCore Token — homepage chat widget backend. Thin wrapper around
// handleIncomingMessage() -- reached by anonymous, pre-connect visitors,
// so identity here is a client-generated visitorId, not a wallet address.
