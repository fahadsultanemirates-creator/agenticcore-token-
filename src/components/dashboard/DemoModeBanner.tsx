  ...
  return (
    <div className="flex items-start gap-3 rounded-xl border border-ac-cyan/30 bg-ac-cyan/10 px-4 py-3">
      ...
      <p className="text-xs text-ac-muted sm:text-sm">
        ...
        live on-chain and the buy widget below is real — but the referral
        tree, counts, and reward numbers on this page are a sample layout
        showing how your tree will look, not your real downline yet. Your
        referral link (above) is already live and ready to share.
      </p>
    </div>
  );
}
